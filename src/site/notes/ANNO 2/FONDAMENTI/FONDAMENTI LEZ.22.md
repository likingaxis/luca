...
Perciò $$\text{dspace(T,x)} \le \text{dtime(T,x)}$$e dato che $$\text{dtime} \in O(f(|x|))$$ (per [[ANNO 2/FONDAMENTI/FONDAMENTI LEZ.22#Efficienza temporale - DTIME\|definizione DTIME]]) 
