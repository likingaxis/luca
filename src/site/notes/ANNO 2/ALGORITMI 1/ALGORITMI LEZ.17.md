...
>![Pasted image 20241223095643.png|300](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223095643.png)
>esempio slide prof
>![Pasted image 20241223095822.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223095822.png)

### ESEMPIO con pesi negativi
si può notare come ci sia $-1$ o $-10$
questo non si può fare con Dijkstra
![Pasted image 20241223095918.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223095918.png)
Un cammino minimo viene detto **distanza**

##### PROBLEMA reale: 
dati u e v, trovare un cammino minimo(distanza) tra due nodi
![Pasted image 20241223100034.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223100034.png)
...
- se abbiamo un cammino con un ciclo che ha un costo negativo allora non va bene
	- diciamo che e $-\infty$
![Pasted image 20241223100551.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223100551.png)
...
![Pasted image 20241223100856.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223100856.png)

##### Disuguaglianza triangolare
$\forall \ u,v,x \in V  \ \ \ vale \ \ \ d(u,v) \le d(u,x) + d(x,v)$
$d$ indica la distanza
![Pasted image 20241223101113.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223101113.png)
...
![Pasted image 20241223104345.png|300](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223104345.png)
...
![Pasted image 20241223105120.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223105120.png)
![Pasted image 20241223105141.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223105141.png)


#### ESERCIZIO PER CASA
![Pasted image 20241223105602.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223105602.png)
#### Ora parliamo del vero e proprio DIJKSTRA
Assumiamo che tutti i pesi siano $\geq0$
- ogni arco $(u,w)$ ha $w(u,w)\geq0$
###### Idea dell'algoritmo
![Pasted image 20241223111829.png|300](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223111829.png)
...
![Pasted image 20241223115515.png|300](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223115515.png)
...
#### PSEUDOCODICE
![Pasted image 20241223121034.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223121034.png)
...
- se la media attesa già esiste
	...
	- compreso il padre
![ezgif.com-speed_14.gif](/img/user/ANNO%202/FOTOANNO2/fotoalg/ezgif.com-speed_14.gif)
...
![Pasted image 20241223123500.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223123500.png)
...
![Pasted image 20241223142320.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223142320.png)
...
![Pasted image 20241223142848.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241223142848.png)
### COMPLESSITÀ
#### Complessità
