...
![Pasted image 20241125114548.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125114548.png)
...
>![Pasted image 20241125122132.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125122132.png)
>![Pasted image 20241125120444.png|500](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125120444.png)

>[!quote]- piccolo catch per l'esame
>quando si chiede la definizione di sta roba, non si deve fare 
>
>![Pasted image 20241125122149.png|300](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125122149.png)
>
>perché bisogna giustificarlo per ogni sottoalbero

###### Altro esempio di un BST
![Pasted image 20241125122911.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125122911.png)
#### Ordinamenti del BST
...
![Pasted image 20241125123742.png|300](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125123742.png)

>[!bug] RICORSIVAMENTE OGNI RADICE AVRA A SX E DX I RISPETTIVI > E <
###### VERIFICA CORRETTEZZA VISITA SIMMETRICA DEL BST
![Pasted image 20241125124703.png|600](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125124703.png)
![Pasted image 20241125124717.png|600](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125124717.png)
...
`Search(7)`
![Pasted image 20241125125235.png|500](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125125235.png)

###### PSEUDO
![Pasted image 20241125125206.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125125206.png)
- $T$ albero
...
`Insert(e,8)`
![Pasted image 20241125151335.png|500](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125151335.png)
###### COSTO
$O(altezza albero)$
...
![Pasted image 20241125152032.png|500](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125152032.png)
- tiriamo dritti ai vari figli destri di $v$ ovvero
![Pasted image 20241125152920.png|500](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125152920.png)
...
###### PSEUDOCODICE
![Pasted image 20241125155837.png|500](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125155837.png)
...
![Pasted image 20241125160643.png|400](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125160643.png)
###### COSTO
$O(altezza \ albero)$
...
![Pasted image 20241125160903.png|500](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125160903.png)
###### COSTO
$O(altezza \ albero)$
...
![Pasted image 20241125162224.png|350](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125162224.png)
3. se $u$ ha due figli 
...
![Pasted image 20241125162709.png|600](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125162709.png)


>[!info]- ESEMPIO
>![Pasted image 20241125163306.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125163306.png)
...
![Pasted image 20241125164247.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125164247.png)

##### CASO LINEARIZZATO $O(n)$
![Pasted image 20241125164322.png](/img/user/ANNO%202/FOTOANNO2/fotoalg/Pasted%20image%2020241125164322.png)
